...
export function AppHeader({ title, subtitle, left, right, sticky = true }: AppHeaderProps) {
  return (
    <header className={cn(
      ...
      <div className="safe-px mx-auto max-w-screen-md">
        <div className="h-12 flex items-center justify-between gap-2 px-4">
          ...
          <div className="min-w-[40px] flex items-center justify-end gap-1">{right ?? null}</div>
        </div>
      </div>

-- Fan Club Z Wallet Functions for Supabase (USD VERSION)
-- Run this SQL in your Supabase SQL Editor

-- Drop existing function if it exists
DROP FUNCTION IF EXISTS update_wallet_balance(UUID, TEXT, DECIMAL, DECIMAL);

-- Create the update_wallet_balance RPC function with USD as default
...
BEGIN
  ...
  IF test_user_id IS NOT NULL THEN
    -- Test the function
    SELECT * INTO result_record FROM update_wallet_balance(test_user_id, 'USD', 0, 0);

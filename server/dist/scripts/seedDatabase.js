...
exports.samplePredictionOptions = exports.samplePredictions = exports.sampleUsers = void 0;
...
exports.samplePredictions = samplePredictions;
...
async function seedDatabase() {
    ...
    try {
        ...
        const { data: usersData, error: usersError } = await database_1.supabase
            .from('users')
            .insert(sampleUsers)
            .select();
        if (usersError) {
        ...
        const { data: predictionsData, error: predictionsError } = await database_1.supabase
            .from('predictions')
        ...
        const { data: optionsData, error: optionsError } = await database_1.supabase
            .from('prediction_options')
        ...
        const { data: verifyPredictions, error: verifyError } = await database_1.supabase
            .from('predictions')
            .select(`
        *,

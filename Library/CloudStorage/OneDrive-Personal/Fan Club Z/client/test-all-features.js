...
async function testAllFeatures() {
  ...
  try {
    ...
    console.log('\n🧭 Test 4: Navigation between tabs');
    const tabs = ['Activity', 'Clubs', 'Wallet', 'Profile'];
    ...
    console.log('\n🔍 Test 9: Search functionality');
    try {
      await page.fill('input[placeholder="Search bets..."]', 'Bitcoin');
      await page.waitForTimeout(1000);
    ...
    try {
      ...
      console.log('✅ Wallet functionality works');
      results.passed.push('Wallet functionality');
    } catch (error) {
      console.log('❌ Wallet functionality failed:', error.message);
      results.failed.push('Wallet functionality');
    }
    results.total++;

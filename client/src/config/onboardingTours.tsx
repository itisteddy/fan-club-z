...
export const DISCOVER_PAGE_TOUR = {
  steps: [
    ...
    },
    {
      ...
      description: `Scroll through active predictions. Tap any card to see details and ${t('betVerb').toLowerCase()}.`,
...
export const PREDICTION_DETAILS_TOUR = {
  steps: [
    ...
    },
    {
      ...
      description: `Select which outcome you want to ${t('bet')}. Each option shows the current pool size.`,
      placement: 'center',
    ...
    },
    {
      ...
      description: `Enter the amount you want to ${t('bet')} and tap "${t('betVerb')}" to confirm. The button is positioned above the bottom navigation for easy access.`,
      placement: 'center',
      icon: <DollarSign className="w-5 h-5" />,
      action: 'modal'
    },
...
export const WALLET_PAGE_TOUR = {
  steps: [
    ...
    },
    {
      ...
      description: `View all your deposits, withdrawals, ${t('bets')}, and ${t('winnings').toLowerCase()} in your transaction history.`,

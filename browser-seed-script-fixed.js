// Browser Console Seeding Script - FIXED VERSION
// Copy and paste this entire script into your browser console on https://fan-club-z.vercel.app
...
if (!supabase) {
  console.error('❌ Supabase client not found. Make sure you are logged in to the app.');
  return;
}
...
async function seedDatabase() {
  try {
    ...
    const comments = [
      { prediction_id: 'pred1111-1111-1111-1111-111111111111', user_id: user.id, content: 'Man City has the strongest squad depth in the league. Pep Guardiola knows how to win titles!' },
      { prediction_id: 'pred2222-2222-2222-2222-222222222222', user_id: user.id, content: 'Bitcoin halving in 2024 + institutional adoption = $100k+ by 2025!' },
      { prediction_id: 'pred3333-3333-3333-3333-333333333333', user_id: user.id, content: 'This season has some really interesting housemates. The drama is going to be intense!' },
    ];
    ...
    const reactions = [
      { prediction_id: 'pred1111-1111-1111-1111-111111111111', user_id: user.id, type: 'like' },
      { prediction_id: 'pred2222-2222-2222-2222-222222222222', user_id: user.id, type: 'fire' },
      { prediction_id: 'pred3333-3333-3333-3333-333333333333', user_id: user.id, type: 'thinking' },
    ];
    ...
    console.log('- 3 reactions created');
    console.log('- 1 transaction created');
    console.log('');
    console.log('🔄 Refreshing the page to show new data...');

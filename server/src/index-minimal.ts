...
app.get('/api/predictions/entries/me', (req, res): void => {
...
app.post('/api/v2/predictions/:id/like', (req, res): void => {
...
app.get('/api/v2/predictions/:id/likes', (req, res): void => {
  const { id: predictionId } = req.params;
...
// Comment endpoints
app.get('/api/v2/predictions/:id/comments', (req, res): void => {
  const { id: predictionId } = req.params;
...
app.post('/api/v2/predictions/:id/comments', (req, res): void => {
  const { id: predictionId } = req.params;
...
app.post('/api/v2/comments/:id/like', (req, res): void => {

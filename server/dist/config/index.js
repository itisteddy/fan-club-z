...
exports.config = {
    ...
    payment: {
        demoMode: process.env.PAYMENT_DEMO_MODE !== 'false',
        demoSuccessRate: parseFloat(process.env.DEMO_PAYMENT_SUCCESS_RATE || '0.9'),
        demoProcessingDelay: parseInt(process.env.DEMO_PAYMENT_DELAY || '3000', 10),
        stripe: {
    ...
    kyc: {
        ...
        basicLimit: parseFloat(process.env.KYC_BASIC_LIMIT || '1000'),
        enhancedLimit: parseFloat(process.env.KYC_ENHANCED_LIMIT || '100000'),
    },
    features: {
...
if (process.env.NODE_ENV === 'production' && exports.config.jwt.secret.length < 32) {

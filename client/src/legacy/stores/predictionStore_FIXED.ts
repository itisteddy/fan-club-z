// THIS IS THE FIXED VERSION WITH closePrediction FUNCTION ADDED
// Replace your existing /client/src/stores/predictionStore.ts with this file
// Or manually copy the closePrediction function (lines 386-410) into your existing file
...
interface PredictionState {
  ...
  closePrediction: (predictionId: string) => Promise<{ success: boolean; data?: any }>;  // <-- ADDED THIS
}
...
export const usePredictionStore = create<PredictionState>()(
  ...
  placePrediction: async (predictionId: string, optionId: string, amount: number, transactionHash: string, userId: string) => {
    ...
    try {
      ...
      // ============================================
      // CRITICAL FIX: Added closePrediction function
      // ============================================

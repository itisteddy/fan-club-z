...
export const FULL_CONTEXTUAL_TOUR: OnboardingStep[] = [
  // Step 1: Welcome
  {
    ...
    description: `Let's show you the essentials in just 5 quick steps. You'll learn how to discover predictions, create your own, track ${L("bets")}, and manage your wallet.`,
    placement: 'center',
  ...
  // Step 2: Discover Predictions (Discover page)
  {
    ...
    description: `Browse active predictions here. Each card shows the title, category, pool size, and closing date. Tap any card to ${L("betVerb").toLowerCase()}!`,
  ...
  {
    id: 'navigate-to-bets',
    title: `Track Your ${L("bets")}`,
    description: `Visit the ${L("myBets")} tab to track all your active predictions, see predictions you've created, and review completed ${L("bets")}.`,
    target: 'tab-bets',
    placement: 'top',
    offset: { y: -40 },
  ...
  // Step 5: Manage Wallet (Navigate to Wallet page)
  {
    ...
    description: `Your Wallet is where you add funds, withdraw ${L("winnings")}, and track all transactions. Let's check it out!`,
    target: 'tab-wallet',
    placement: 'top',
    offset: { y: -40 },
...
export const QUICK_DISCOVER_TOUR: OnboardingStep[] = [
  ...
  },
  {
    ...
    description: `Scroll through active predictions. Tap any card to view details and ${L("betVerb").toLowerCase()}.`,
    target: 'discover-list',
    placement: 'top',
    offset: { y: -40 },
    icon: <BarChart3 className="w-5 h-5" />,

 ...
 * 
 * Usage: node client/scripts/enforce-freeze.mjs
...
const allowed = [
  ...
  "README.md",
  "docs/",
  "client/scripts/check-duplicates.mjs",
  "client/scripts/enforce-freeze.mjs",
];
...
const criticalPaths = [
  ...
  "client/tsconfig.json", // No compiler changes
  "server/src/",          // No server changes during freeze
];

...
exports.FEATURES = { REAL_TIME_COMMENTS: true, SOCIAL_ENGAGEMENT: true, WALLET_INTEGRATION: true, CLUB_SYSTEM: true, SETTLEMENT_SYSTEM: true, ANALYTICS: true };
exports.API_VERSIONS = { PREDICTIONS: "v2", SOCIAL: "v2", WALLET: "v2", CLUBS: "v2" };
...
exports.versionInfo = { version: exports.VERSION, buildDate: exports.BUILD_DATE, environment: exports.BUILD_ENV, features: exports.FEATURES, apiVersions: exports.API_VERSIONS };

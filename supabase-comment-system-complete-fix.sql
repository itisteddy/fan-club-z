-- =====================================================
-- Fan Club Z: Complete Comment System Fix
-- =====================================================
...
CREATE TABLE comments (
  ...
  INDEX idx_comments_tree (prediction_id, parent_comment_id, created_at DESC)
);
...
CREATE TABLE comment_reports (
  ...
  INDEX idx_comment_reports_created_at (created_at DESC)
);
...
WHERE pg_namespace.nspname = 'public' 
  AND pg_class.relname IN ('comments', 'comment_likes', 'comment_reports')

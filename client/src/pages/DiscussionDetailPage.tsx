...
const DiscussionDetailPage: React.FC<DiscussionDetailPageProps> = ({ 
  ...
  useEffect(() => {
    const mockDiscussion: Discussion = {
      ...
      authorAvatar: 'FF',
      content: 'What do you think about the current title race? Arsenal looking strong but City have the experience. Liverpool also can\'t be counted out despite their recent struggles. This season feels wide open and any of the top 4 could realistically win it.',
      replies: 23,
      likes: 45,
      timestamp: '2h ago',
      isPinned: true,
    ...
    const mockComments: Comment[] = [
      {
        ...
        author: 'GoalDigger',
        authorAvatar: 'GD',
        content: 'I think Arsenal has the momentum right now. Their young squad is hungry and Arteta has really built something special. If they can avoid major injuries, they\'re my pick.',
        timestamp: '1h ago',
        likes: 12,
        isLiked: false,
        replies: [
          {
            id: '1-1',
            author: 'CitySupporter',
            authorAvatar: 'CS',
            content: 'Arsenal always start strong but fade in the second half of the season. City\'s experience in title races will show when it matters.',
            timestamp: '45m ago',
            likes: 8,
            isLiked: false
          },
          {
            ...
            author: 'NeutralFan',
            authorAvatar: 'NF',
            content: 'Both teams have their strengths. Arsenal\'s youth vs City\'s experience - classic storyline!',
            timestamp: '30m ago',
            likes: 5,
            isLiked: true
          }
      ...
      },
      {
        ...
        author: 'StatMaster',
        authorAvatar: 'SM',
        content: 'Looking at the underlying stats, City still has the best defense in the league. That\'s usually what wins titles. Arsenal needs to tighten up at the back.',
        timestamp: '50m ago',
        likes: 18,
        isLiked: true
      },
      {
        ...
        author: 'RedDevil',
        authorAvatar: 'RD',
        content: 'Don\'t sleep on United! We\'re building momentum and have a good squad depth this season. Anything can happen in football.',
        timestamp: '25m ago',
        likes: 6,
        isLiked: false
      }

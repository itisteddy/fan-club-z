        ...
        const clubs = [
            {
                ...
                owner_id: userProfiles[1]?.id || userProfiles[0]?.id,
                visibility: 'public',
            ...
            },
            {
                ...
                owner_id: userProfiles[2]?.id || userProfiles[0]?.id,
                visibility: 'public',
            ...
            },
            {
                ...
                owner_id: userProfiles[3]?.id || userProfiles[0]?.id,
                visibility: 'public',
            ...
            },
            {
                ...
                owner_id: userProfiles[4]?.id || userProfiles[0]?.id,
                visibility: 'public',

              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white rounded-2xl border border-black/[0.06] p-4 min-h-[88px] flex flex-col justify-center">
                  ...
                  <div className="text-xl font-semibold text-gray-900 font-mono">
                    {formatCurrency(balance - totalDeposits, 'USD', true)}
                  </div>
                </div>
                <div className="bg-white rounded-2xl border border-black/[0.06] p-4 min-h-[88px] flex flex-col justify-center">
                  <div className="flex items-center space-x-1 mb-2">
                  ...
                  <div className="text-xl font-semibold text-gray-900 font-mono">
                    {formatCurrency(totalDeposits, 'USD', true)}
                  </div>
                </div>
                <div className="bg-white rounded-2xl border border-black/[0.06] p-4 min-h-[88px] flex flex-col justify-center">
                  <div className="flex items-center space-x-1 mb-2">
                      ...
                      <div key={transaction.id} className="flex items-center justify-between py-2">
                        ...
                        <div className="text-right">
                          <div className={`text-sm font-medium ${
                            ...
                            {transaction.type === 'deposit' ? '+' : '-'}{formatCurrency(Math.abs(transaction.amount), 'USD', true)}
                          </div>
